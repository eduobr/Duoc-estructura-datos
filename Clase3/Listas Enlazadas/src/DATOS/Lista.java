...
public class Lista {
    ...
    public void eliminar(Object entrada) {
        ...
        while ((actual != null) && (!encontrado)) {
            encontrado = (actual.getDato() == entrada); //.equals para cualquier tipo de dato
    ...
    public void ordNodos() {
        //Nodo actual=primero;
        Nodo j = primero;
        Nodo aux=null;
        for (Nodo i = primero; i == null; i.getEnlace()) {
            while (j != null && (int)aux.getDato()<(int)j.getDato()) {
                System.out.println(j.getDato());
                j = j.getEnlace();
            }
        }
    }
